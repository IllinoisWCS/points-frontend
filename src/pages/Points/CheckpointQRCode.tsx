// almost exact coy of EventQRCode.tsx
...
const CheckpointQRCode: React.FC<CheckpointQRCodeProps> = ({
  ...
  const downloadSVG = (): void => {
    ...
    // names the link
    downloadLink.download = `qr-code-${checkpointKey}.svg`;
    // adds link to page
  ...
  const downloadPNG = (): void => {
    ...
    img.onload = () => {
      ...
      downloadLink.download = `qr-code-${checkpointKey}.png`;
      document.body.appendChild(downloadLink);
      downloadLink.click();
      document.body.removeChild(downloadLink);
    };
      ...
      >
        <HStack ml="auto" spacing={4}>
          <QRCodeSVG
            ...
            level="H"
            title={`QR code for checkpoint key ${checkpointKey}`}
          />
